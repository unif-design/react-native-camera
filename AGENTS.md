# Agent Rules — @unif/react-native-camera

<!-- BEGIN:unif-agent-rules -->
## Using this library (as a consumer)

- **Agent Skill**: `using-unif-camera` (in the `unif-react-native` plugin). Install:
...
- **API docs** (plain Markdown, fetch on demand — don't guess APIs from memory):
  - Index: https://unif-design.github.io/react-native-camera/llms.txt
  - Full text: https://unif-design.github.io/react-native-camera/llms-full.txt
