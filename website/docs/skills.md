---
title: AI Skill
description: "using-unif-camera 是一个 Agent Skill,教 AI 编码助手正确调用 @unif/react-native-camera 的 API、避免常见幻觉。"
---

# AI Skill：using-unif-camera

## 这是什么

`using-unif-camera` 是一个 **Agent Skill**,教 AI 编码助手(Claude Code / Cursor / Codex)正确调用 `@unif/react-native-camera` 的 API、避免常见幻觉。
...
👉 **[github.com/unif-design/react-native-skills · using-unif-camera](https://github.com/unif-design/react-native-skills/tree/main/skills/using-unif-camera)**
