...
它在 vision-camera 之上封装了一套**模态化的拍摄界面**:取景、拍照、连拍、录像、滚条变焦(连续,含 0.5x 超广角)、点击对焦、前后摄翻转、拍后预览确认、给照片烧水印——这些都做好了,你只需要调一个方法把它弹出来。
...
- **滚条变焦 · 点击对焦 · 前后摄翻转** —— 取景器内置手势(变焦为底部连续水平滚条,含 0.5x 超广角档;前置摄像头无变焦条)
